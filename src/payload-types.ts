...
export interface ProductGridBlock {
  ...
  source?: ('featured' | 'residential' | 'commercial' | 'manual') | null;
  manualProducts?: (number | Product)[] | null;
  /**
   * Maximum number of products to display (ignored for manual mode).
   */
  limit?: number | null;
  id?: string | null;
...
export interface Product {
  ...
  summary: string;
  /**
   * e.g. "£500,000 – £25 million"
   */
  loanRange?: string | null;
  /**
   * e.g. "3–36 months"
   */
  term?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CaseStudyShowcaseBlock".
 */
export interface CaseStudyShowcaseBlock {
  eyebrow?: string | null;
  heading?: string | null;
  subheading?: string | null;
...
/**
 * Real-world lending scenarios used to build trust with brokers and borrowers.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface CaseStudy {
  ...
  title: string;
  /**
   * One or two sentences used on cards and listing pages.
   */
  summary: string;
  /**
   * e.g. "£2.4M"
  ...
  image?: (number | null) | Media;
  /**
   * Show on the home page case studies section.
   */
  featured?: boolean | null;
  publishedAt?: string | null;
  /**
...
/**
 * Quick Enquiry form submissions from the public website.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CaseStudyShowcaseBlock_select".
 */
export interface CaseStudyShowcaseBlockSelect<T extends boolean = true> {
  eyebrow?: T;
  heading?: T;
  subheading?: T;
  source?: T;
